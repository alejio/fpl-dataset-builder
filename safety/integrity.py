...
def validate_data_integrity(data_dir: str = "data") -> dict[str, bool]:
    ...
    try:
        ...
        if (data_path / "fpl_players_current.csv").exists() and \
           (data_path / "fpl_player_xg_xa_rates.csv").exists():
        ...
        if (data_path / "fpl_teams_current.csv").exists() and \
           (data_path / "fpl_players_current.csv").exists():

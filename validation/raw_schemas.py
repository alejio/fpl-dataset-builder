...
class RawBettingOddsSchema(pa.DataFrameModel):
    ...
    B365H: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)  # Decimal odds must be >= 1.0
    B365D: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    B365A: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Pre-match odds - Pinnacle (3 fields)
    PSH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    PSD: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    PSA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Pre-match odds - Market aggregates (6 fields)
    MaxH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    MaxD: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    MaxA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgD: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Closing odds - Bet365 (3 fields)
    B365CH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    B365CD: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    B365CA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Closing odds - Pinnacle (3 fields)
    PSCH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    PSCD: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    PSCA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Closing odds - Market aggregates (6 fields)
    MaxCH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    MaxCD: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    MaxCA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgCH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgCD: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgCA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Over/Under 2.5 goals - Bet365 (2 fields)
    B365_over_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    B365_under_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Over/Under 2.5 goals - Betfair Exchange (2 fields)
    BFE_over_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    BFE_under_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Over/Under 2.5 goals - Market aggregates (4 fields)
    Max_over_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    Max_under_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    Avg_over_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    Avg_under_2_5: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)

    # Asian Handicap (7 fields)
    AHh: Series[pd.Float64Dtype] = pa.Field(nullable=True)  # Can be positive or negative
    B365AHH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    B365AHA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    PAHH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    PAHA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgAHH: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
    AvgAHA: Series[pd.Float64Dtype] = pa.Field(nullable=True, ge=1.0)
